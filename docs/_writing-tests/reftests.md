...
page containing the `<href rel=[mis]match>` elements). In the simplest
...
would allow for a maximum difference of 15 / 255 on any color channel
and 300 pixels total difference. The values may also be given as
ranges e.g.
